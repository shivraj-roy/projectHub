   ...
   return (
      <aside className="w-80 h-screen bg-white border-r border-gray-200">
         ...
         <div className="px-4 py-2">
            <button className="flex items-center justify-center gap-4 w-full p-4 text-lg font-semibold cursor-pointer rounded-4xl text-white bg-gray-600 hover:bg-gray-800">
